from astatsa.utils import expect_shape
...
class BGDSmodel(object):
    ...
    def publish_2d(self, pub):
        ...
        grad_labels = ['h', 'v']
        from boot_agents.misc_utils import display_4d_tensor, display_3d_tensor
    ...
    def publish_1d(self, pub):
        from boot_agents.misc_utils import display_1d_tensor
